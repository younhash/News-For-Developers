...
const sendMe = async () => {
    ...
    <p> ${fillTopNews.topArticle[3].publishDate}</p>
    ...
    <p> ${fillTopNews.topArticle[4].publishDate}</p>
    ...
    <p> ${fillTopNews.topArticle[5].publishDate}</p>
    ...
    <p> ${fillTopNews.topArticle[6].publishDate}</p>
    ...
    <p> ${fillTopNews.topArticle[7].publishDate}</p>
    ...
    <p> ${fillTopNews.topArticle[8].publishDate}</p>
    ...
    <p> ${fillTopNews.topArticle[9].publishDate}</p>
